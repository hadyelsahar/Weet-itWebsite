...
namespace weetit_website.ServiceReference1 {
    ...
    public interface ProfileConstructorInterface {
        ...
        weetit_website.ServiceReference1.LiteralProfile ConstructLiteralProfile(string subjectURI, string predicate_label, string subject_label, string object_URI, string object_value, string pred_URI);
    }
    ...
    public partial class ProfileConstructorInterfaceClient : System.ServiceModel.ClientBase<weetit_website.ServiceReference1.ProfileConstructorInterface>, weetit_website.ServiceReference1.ProfileConstructorInterface {
        ...
        public weetit_website.ServiceReference1.LiteralProfile ConstructLiteralProfile(string subjectURI, string predicate_label, string subject_label, string object_URI, string object_value, string pred_URI) {
